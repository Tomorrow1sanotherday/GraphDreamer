...
#
# Examples:
#   ./run.sh --input_path /path/to/scene_graphs.json --output_dir /path/to/images
#   ./run.sh --model stabilityai/stable-diffusion-xl-base-1.0 --image_format png
...
OUTPUT_DIR="${PROJECT_ROOT}/data/cub2011/syn_images/co_object_5/scene_graphs_30000_deepseekv4f"
OUTPUT_JSON="${PROJECT_ROOT}/data/cub2011/syn_images/co_object_5/syn_train_index_30000_deepseekv4f.json"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  --image_format FORMAT     Image format: jpg or png (default: jpg)"
            echo "  --filename_prefix PREFIX  Filename prefix (default: syn_image)"
            echo "  --dataset_name NAME       Dataset name (default: cub_2011_synthetic)"
...
echo "========================================"
echo "Image Generation from Scene Graphs"
echo "========================================"
