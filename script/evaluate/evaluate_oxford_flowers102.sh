#!/usr/bin/env bash
# Evaluate synthetic data for Oxford Flowers 102 dataset
# Usage: bash evaluate_oxford_flowers102.sh

# ========== 参数配置 ==========
SYN_INDEX=""
SYN_ROOT="/mnt/sda/runhaofu/GraphDreamer/data/oxford_flowers102/syn_images/co_object_5/scene_graphs_optimized_3060_deepseekv4f_v0_images"
...
DETAILED_RESULTS=1
SEED=42
CONFIG="config/config_oxford_flowers102.yaml"
