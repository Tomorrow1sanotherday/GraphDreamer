#!/usr/bin/env bash
# Evaluate synthetic data for Stanford Cars dataset
# Usage: bash evaluate_stanford_car.sh

# ========== 参数配置 ==========
SYN_INDEX=""
# SYN_ROOT="/mnt/sda/runhaofu/AttrSyn/data_generation/datasets/synthetic/stanford_car-photo/sdxl-attrsyn-30per"
# SYN_ROOT="/mnt/sda/runhaofu/GraphDreamer/data/stanford_car/syn_images/base_prompts_5880"
SYN_ROOT="/mnt/sda/runhaofu/GraphDreamer/data/stanford_car/syn_images/base_prompts_5880_v3"
N_PER_CLASS=3
SYN_SAMPLES=""
BATCH_SIZE=32
RESIZE=""
...
DETAILED_RESULTS=1
SEED=42
CONFIG="config/config_stanford_car.yaml"
