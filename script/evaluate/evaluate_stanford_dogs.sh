#!/usr/bin/env bash
# Evaluate synthetic data for Stanford Dogs dataset
# Usage: bash evaluate_stanford_dogs.sh

# ========== 参数配置 ==========
SYN_INDEX=""
SYN_ROOT="/mnt/sda/runhaofu/AttrSyn/data_generation/datasets/synthetic/stanford_dogs-photo/sdxl-attrsyn-30per"
...
DETAILED_RESULTS=1
SEED=42
CONFIG="config/config_stanford_dogs.yaml"
...
# open_clip 预训练权重 tag。非空时强制走 open_clip backend。
