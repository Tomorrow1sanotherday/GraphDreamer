#!/usr/bin/env bash
# Evaluate synthetic data for FGVC-Aircraft dataset
# Usage: bash evaluate_fgvc_aircraft.sh

# ========== 参数配置 ==========
SYN_INDEX=""
SYN_ROOT="/mnt/sda/runhaofu/GraphDreamer/data/fgvc_aircraft/syn_images/co_object_5"
...
DETAILED_RESULTS=1
SEED=42
CONFIG="config/config_fgvc_aircraft.yaml"
