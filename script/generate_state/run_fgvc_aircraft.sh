...
# Script to run the subject state generation for FGVC-Aircraft
# Usage: ./run_fgvc_aircraft.sh [n_states] [model_name]
...
OUTPUT_DIR="${PROJECT_ROOT}/data/fgvc_aircraft/states"
N_STATES="${1:-5}"
MODEL_NAME="${2:-deepseek-v4-flash}"

echo "====================================="
echo "Subject State Generation - FGVC-Aircraft"
echo "====================================="
