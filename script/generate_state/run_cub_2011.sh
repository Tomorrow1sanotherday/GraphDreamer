...
# Script to run the subject state generation
# Usage: ./run.sh [n_states] [model_name]
...
OUTPUT_DIR="${PROJECT_ROOT}/data/cub2011/states"
N_STATES="${1:-5}"
MODEL_NAME="${2:-deepseek-v4-flash}"

echo "====================================="
echo "Subject State Generation Script"
echo "====================================="
